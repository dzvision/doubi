...
#=================================================
#源码0.11.8已经无法正常下载，需要替换连接。
#FTP位置需要密码，更换地址为gitlab地址
#=================================================
sh_ver="1.0.6"
...
#	Old Version from Doubi 老版本 
#	原始地址解析结果：ftp://ftp.infradead.org/pub/ocserv/ocserv-0.11.8.tar.xz
#===============================================================================
	wget "https://gitlab.com/openconnect/ocserv/-/archive/ocserv_0_12_3/ocserv-ocserv_0_12_3.tar.gz"
#===================================================================================================================================================================	
...
#===================================================================================================================================================================
	...
	tar -xf ocserv-ocserv_0_12_3.tar.gz && cd ocserv-ocserv_0_12_3
	./configure	
	make
	make install
	cd .. && cd ..
	...
	if [[ -e ${file} ]]; then
		mkdir "${conf_file}"
		wget --no-check-certificate -N -P "${conf_file}" "https://raw.githubusercontent.com/dzvision/doubi/master/other/ocserv.conf"
...
Update_Shell(){
	...
	wget -N --no-check-certificate "https://raw.githubusercontent.com/dzvision/doubi/master/ocserv.sh" && chmod +x ocserv.sh
